    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-orange-600 mt-2">{pendingVendors} pending approval</p>
        </div>
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4].map((order) => (
                <div key={order} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">Order #ORD-{2000 + order}</p>
                    <p className="text-sm text-gray-600">Customer • Vendor Store</p>
                  </div>
                  <div className="text-right">
                    <p className="font-medium text-gray-900">${(149.99 + order * 20).toFixed(2)}</p>
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((vendor) => (
                <div key={vendor} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">New Tech Store {vendor}</p>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage vendor applications and stores</p>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[
                { name: 'John Vendor', store: 'Tech Store', status: 'approved', products: 12, sales: 5420 },
                { name: 'Jane Smith', store: 'Fashion Hub', status: 'approved', products: 8, sales: 3210 },
                { name: 'Mike Wilson', store: 'Sports World', status: 'pending', products: 0, sales: 0 },
                { name: 'Sarah Davis', store: 'Beauty Co', status: 'approved', products: 15, sales: 8930 }
              ].map((vendor, index) => (
