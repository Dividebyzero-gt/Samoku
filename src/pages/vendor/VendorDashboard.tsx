...
const VendorDashboard: React.FC = () => {
  ...
  // Mock vendor data
  const vendorProducts = getVendorProducts(user?.id || '').concat(
    mockProducts.filter(p => p.vendorName === user?.vendorInfo?.storeName && !p.isDropshipped)
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-blue-600 mt-2">+8 this week</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-purple-600 mt-2">Active listings</p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="text-sm text-orange-600 mt-2">Repeat buyers: 78%</p>
        </div>
      </div>
            ...
            {[1, 2, 3].map((order) => (
              <div key={order} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium text-gray-900">${(99.99 + order * 10).toFixed(2)}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              type="text"
              value={user?.vendorInfo?.storeName || ''}
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              rows={4}
              value={user?.vendorInfo?.storeDescription || ''}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
        </div>
          ...
          <div className="lg:w-64">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="text-center mb-6">
                ...
                <h3 className="font-semibold text-gray-900">{user?.vendorInfo?.storeName}</h3>
